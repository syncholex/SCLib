...
if (true)
 {
    Java.perform(function () {
        ...
        if (true) {
            ...
            try {
                var CertificatePinner = Java.use("cu2");//("Zb2"); //search by "sha256/"  //("W92");// Java.use("C72");// Java.use("W92");// Java.use("C72");// Java.use("Y32"); // Java.use("tux"); //Java.use("rfx"); // Java.use("SIv");
            ...
            try {
                ...
                var CronetPinning = Java.use("o95");//("dI4");//("Ly4");// search by "DISABLE_PINNING))" // Java.use("cu4");// Java.use("My4");// Java.use("cu4"); // Java.use("yl4"); // Java.use("enm"); // Java.use("Zbm"); //Java.use("n2l");
